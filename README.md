...
| 技术 | 用途 |
|------|------|
| React 18.3.x + TypeScript 5.5.x | 前端框架 |
| Vite 5.4.x | 构建工具 |
| Ant Design Mobile 5.x + Ant Design Mobile Icons | UI 组件库 |
| Recharts 2.x | 图表库 |
| Dayjs 1.x | 日期时间处理 |
| Supabase JS SDK 2.x | 后端数据访问 |
| Vitest 4.x | 单元测试 |
...
- Edge Function 调用东方财富 API 时自动模拟移动端 UA: `EMProjJijin/8.4.6 (iPhone; iOS 16.0; Scale/3.00)` + Referer 头
